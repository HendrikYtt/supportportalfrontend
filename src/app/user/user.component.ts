...
export class UserComponent implements OnInit, OnDestroy {
  ...
  public searchUsers(searchTerm: string): void {
    ...
    if (results.length === 0 || !searchTerm) {
      ...
      if (this.searching === false && results.length === 0) {
        this.notificationService.notify(NotificationType.ERROR, 'No users found.');
        this.searching = true;
      }
  ...
  public get isAdmin(): boolean {
    return this.getUserRole() === Role.MANAGER || this.getUserRole() === Role.OWNER;
  }
